...
def psi_e_rad(e: float) -> float:
    ...
    b1 = sqef * (1.0 - (11.0 / 7.0) * e2) * phi_e(e) - (
        1.0 - (3.0 / 7.0) * e2
    ) * phi_e_tilde(e)
...
def x_dot_2_5pn_SF(e: float, eta: float, S1z: float) -> float:
    ...
    x_2_5pn_SF_e0 = pre_factor * (-504.0 * S1z - 1512.0 * S1z**3) / 2016.0
...
def x_dot_3_5pn_SF(e: float, eta: float, S1z: float) -> float:
    ...
    """
    pre_factor: float = 64.0 * eta / 5.0

    x_3_5pn_SF_e0: float = pre_factor * ((-16632.0 * S1z - 38556.0 * S1z**3) / 12096.0)
...
def dxdt_4pn(x: float, eta: float) -> float:
    ...
    bit_4pn = (
        ...
        * (
            ...
            + (
                5.0
                * (-3.7113095238095237 - (35.0 * eta) / 12.0)
                * (
                    19683.0
                    - 66375.0 * eta
                    + 1188.0 * eta2
...
def e_rad_hereditary_2_5(e: float, eta: float, x: float) -> float:
    ...
    a2 = (
        55691.0 * psi_e_rad(e) / 1344.0 + 19067.0 * eta * zed_e_rad(e) / 126.0
    ) * np.pi
    return pre * a2
...
def phi_dot_1_5_pnSO_ecc(
    ...
    if abs(e) < 1e-12:
        return 0.0
    cf = -1.0 + e * np.cos(u)
    return (2 * e * (m1 * S1z + m2 * S2z) * (e - np.cos(u))) / (
        (-1 + e * e) * (m1 + m2) * cf**3
    )
...
def phi_dot_2pn(e: float, eta: float, u: float) -> float:
    ...
    return pre * (
        t0 + t2 + t4 + t6 + c1 + c2 + c3 + np.sqrt(ef) * (r0 + rc1 + rc2 + rc3)
    )
...
def rel_sep_2pn(e: float, u: float, eta: float) -> float:
    ...
    n2 = (
        ...
        * (
            ...
            + 30.0 * eta
            + 8.0 * eta2
            + e * (-72.0 + 7 * (33.0 - 5.0 * eta) * eta) * np.cos(u)
        )
    )
    d2 = 72.0 * ef
    return n1 / d1 + n2 / d2
...
def rel_sep_3pn(e: float, u: float, eta: float) -> float:
    ...
    term1 = (
        ...
        + ((725760.0 * eta_pow_2 - 77490.0 * pi_pow_2 + 5523840.0) * eta - 3628800.0)
        * e_pow_2
        + ((544320.0 * eta_pow_2 + 154980.0 * pi_pow_2 - 14132160.0) * eta + 7257600.0)
    ) * e_pow_2
    ...
    term3_cos = (
        ...
        * e
        * e_pow_2
        + ((-937440.0 * eta_pow_2 - 37845.0 * pi_pow_2 + 6647760.0) * eta - 4989600.0)
        * e
    ) * np.cos(u)

    term4_sqrt = np.sqrt(e_factor) * (
        (
            ((-4480.0 * eta_pow_2 - 25200.0 * eta + 22680.0) * eta - 120960.0) * e_pow_4
            + (
        ...
        * e_pow_2
        + (4480.0 * eta_pow_2 + 45360.0 * eta - 8600904.0) * eta
        + (
            (
                ((-6860.0 * eta_pow_2 - 550620.0 * eta - 986580.0) * eta + 120960.0)
                * e_pow_4
                + (
...
def rel_sep_3pn_SS(
    ...
    m1_4_S1z2 = (
        (
            ...
            + 40 * e_fact_sqrt
            - 84 * kappa1
            + 99 * e_fact_sqrt * kappa1
            + 6
            * e_2
            * (16 + 28 * e_fact_sqrt + 28 * kappa1 + 51 * e_fact_sqrt * kappa1)
    ...
    m1_3_m2 = (
        ...
        * (
            (
                ...
                + 4 * e_fact_sqrt
                - 46 * kappa1
                + 48 * e_fact_sqrt * kappa1
                + e_4 * (-6 - 6 * e_fact_sqrt - 46 * kappa1 + 25 * e_fact_sqrt * kappa1)
                + e_2
                * (12 + 55 * e_fact_sqrt + 92 * kappa1 + 158 * e_fact_sqrt * kappa1)
            )
            * S1z
            + 2
            * (
        ...
        * (
            ...
            * S1z
            + (
                ...
                + 4 * e_fact_sqrt
                - 46 * kappa2
                + 48 * e_fact_sqrt * kappa2
                + e_4 * (-6 - 6 * e_fact_sqrt - 46 * kappa2 + 25 * e_fact_sqrt * kappa2)
                + e_2
                * (12 + 55 * e_fact_sqrt + 92 * kappa2 + 158 * e_fact_sqrt * kappa2)
            )
            * S2z
        )
    )
    ...
    cosu_m1_4_S1z2 = (
        ...
        * (
            12
            + 68 * e_fact_sqrt
            + 3 * (7 + 36 * e_fact_sqrt) * kappa1
            + 3 * e_4 * (4 + 7 * kappa1)
            + 3
            * e_2
            * (-8 + 12 * e_fact_sqrt - 14 * kappa1 + 39 * e_fact_sqrt * kappa1)
        )
        * m1**4
        * S1z
        * S1z
    ...
    cosu_m2_4_S2z2 = (
        ...
        * (
            12
            + 68 * e_fact_sqrt
            + 3 * (7 + 36 * e_fact_sqrt) * kappa2
            + 3 * e_4 * (4 + 7 * kappa2)
            + 3
            * e_2
            * (-8 + 12 * e_fact_sqrt - 14 * kappa2 + 39 * e_fact_sqrt * kappa2)
        )
        * m2**4
        * S2z
        * S2z
    ...
    cosu_m1_3_m2 = (
        ...
        * (
            (
                20 * e_fact_sqrt
                + 33 * e_2 * e_fact_sqrt
                + 110 * e_fact_sqrt * kappa1
                + 121 * e_2 * e_fact_sqrt * kappa1
    ...
    cosu_m1_m2_3 = (
        ...
        * (
            ...
            + (
                20 * e_fact_sqrt
                + 33 * e_2 * e_fact_sqrt
                + 110 * e_fact_sqrt * kappa2
                + 121 * e_2 * e_fact_sqrt * kappa2
    ...
    cosu_m1_2_m2_2 = (
        ...
        * (
            ...
            * S1z
            + 2
            * (87 + 87 * e_4 + 466 * e_fact_sqrt + 3 * e_2 * (-58 + 157 * e_fact_sqrt))
            * S1z
            * S2z
            + 9
            * (
